...
class QwenCloudProvider(ShowrunnerProvider):
    ...
    def _planning_payload(self, project_id: str, project: ProjectInput) -> dict[str, Any]:
        ...
        system = (
            ...
            "The PROP ledger tracks the important prop's physical existence even while hidden: "
            "write 'concealed beneath ...' or 'off-screen at ...', never 'none', if it exists. "
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "Track a concealed or off-screen prop explicitly instead of writing none. "
