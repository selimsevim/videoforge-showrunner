...
class QwenCloudProvider(ShowrunnerProvider):
    ...
    def _planning_payload(self, project_id: str, project: ProjectInput) -> dict[str, Any]:
        ...
        system = (
            ...
            "one active verb, and an object or visible result. Never use 'and', 'while', "
            "'then', or another connector to combine actions. Do not describe sound, fabric "
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "Do not join actions with 'and', 'while', or 'then'. Format both states "
