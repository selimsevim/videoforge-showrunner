...
class QwenCloudProvider(ShowrunnerProvider):
    ...
    def _planning_payload(self, project_id: str, project: ProjectInput) -> dict[str, Any]:
        ...
        system = (
            ...
            "an active verb, and an object or visible result. Do not describe sound, fabric "
            ...
            "tightened grip. Set environmentMotion to exactly 'None.' unless the environment "
            "itself is the primary story action. Use 'Static camera.' by default; otherwise use "
            "only one simple slow push, pull, pan, tilt, rise, or lower. Never combine actor and "
            "complex camera choreography. startState must describe the actor, hands, and prop "
            "immediately before the action. endState must describe their exact positions after "
            "the action without repeating or narrating subjectAction. For every adjacent pair, "
            ...
            "imageDelta a concrete description of the startState composition only; do not show "
            "the action's end result in the first-frame image. "
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "visible physical subjectAction of no more than 18 words, and endState. "
                        "Describe positions in endState without repeating subjectAction. Each "
                        ...
                        "secondary motion. environmentMotion should be 'None.' and cameraMotion "
                        "should be 'Static camera.' unless one basic move is essential. The image "
